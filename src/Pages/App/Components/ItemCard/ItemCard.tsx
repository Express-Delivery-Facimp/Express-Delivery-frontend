...
export default function ItemCard({
  ...
  return (
    <div className="flex flex-col md:flex-row gap-5 text-[#858585] w-full md:w-[40em] rounded-[10px] border-2 border-yellow-300 p-3 cursor-pointer hover:opacity-85">
      <div>
        <img src={image} alt={partner} className="rounded-3xl w-full md:w-30 h-28" />
      </div>
      <div className="flex flex-col gap-1">
        ...
        {cupom && (
          <div className="flex gap-2 items-center bg-emerald-100 px-2 rounded-[10px] text-[#46CC1A] text-sm md:text-base">
